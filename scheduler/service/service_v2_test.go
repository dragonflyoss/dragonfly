			...
			req: &schedulerv2.AnnounceHostRequest{
				Host: &commonv2.Host{
					...
					Network: &commonv2.Network{
						...
						Idc:                      &mockNetwork.IDC,
						RxBandwidth:              &mockNetwork.DownloadRate,
						MaxRxBandwidth:           mockNetwork.DownloadRateLimit,
						TxBandwidth:              &mockNetwork.UploadRate,
						MaxTxBandwidth:           mockNetwork.UploadRateLimit,
					},
					Disk: &commonv2.Disk{
