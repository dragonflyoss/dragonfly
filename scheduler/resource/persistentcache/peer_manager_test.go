...
func mockLoadPeer(mock redismock.ClientMock, mockHostManager *MockHostManagerMockRecorder, mockTaskManager *MockTaskManagerMockRecorder, peerID string) {
	mock.ExpectHGetAll(pkgredis.MakePersistentCachePeerKeyForPersistentCacheTaskInScheduler(42, peerID)).SetVal(mockRawPeerFields(peerID))
...
func mockStorePeerScript(mock redismock.ClientMock) *redismock.ExpectedCmd {
	...
	return mock.CustomMatch(matchScriptArgs).ExpectEvalSha("", []string{
		pkgredis.MakePersistentCachePeerKeyForPersistentCacheTaskInScheduler(42, mockPeer.ID),
		pkgredis.MakePersistentCachePeersOfPersistentCacheTaskInScheduler(42, mockPeer.Task.ID),
		pkgredis.MakePersistentPeersOfPersistentCacheTaskInScheduler(42, mockPeer.Task.ID),
		pkgredis.MakePersistentCachePeersOfPersistentCacheHostInScheduler(42, mockPeer.Host.ID),
	},
		mockPeer.ID,
		mockPeer.Persistent,
...
func mockDeletePeerScript(mock redismock.ClientMock, peerID string) *redismock.ExpectedCmd {
	return mock.CustomMatch(matchScriptArgs).ExpectEvalSha("", []string{
		pkgredis.MakePersistentCachePeerKeyForPersistentCacheTaskInScheduler(42, peerID),
		pkgredis.MakePersistentCachePeersOfPersistentCacheTaskInScheduler(42, mockPeer.Task.ID),
		pkgredis.MakePersistentPeersOfPersistentCacheTaskInScheduler(42, mockPeer.Task.ID),
		pkgredis.MakePersistentCachePeersOfPersistentCacheHostInScheduler(42, mockPeer.Host.ID),
...
func TestPeerManager_Load(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "redis error",
			mock: func(mock redismock.ClientMock, mockHostManager *MockHostManagerMockRecorder, mockTaskManager *MockTaskManagerMockRecorder) {
				mock.ExpectHGetAll(pkgredis.MakePersistentCachePeerKeyForPersistentCacheTaskInScheduler(42, mockPeer.ID)).SetErr(errors.New("redis error"))
			},
			expect: func(t *testing.T, peer *Peer, loaded bool) {
				assert := assert.New(t)
				assert.False(loaded)
		...
		},
		{
			name: "peer not found",
			mock: func(mock redismock.ClientMock, mockHostManager *MockHostManagerMockRecorder, mockTaskManager *MockTaskManagerMockRecorder) {
				mock.ExpectHGetAll(pkgredis.MakePersistentCachePeerKeyForPersistentCacheTaskInScheduler(42, mockPeer.ID)).SetVal(map[string]string{})
			},
			expect: func(t *testing.T, peer *Peer, loaded bool) {
				assert := assert.New(t)
				assert.False(loaded)
		...
		},
		{
			...
			mock: func(mock redismock.ClientMock, mockHostManager *MockHostManagerMockRecorder, mockTaskManager *MockTaskManagerMockRecorder) {
				...
				mock.ExpectHGetAll(pkgredis.MakePersistentCachePeerKeyForPersistentCacheTaskInScheduler(42, mockPeer.ID)).SetVal(fields)
			},
			expect: func(t *testing.T, peer *Peer, loaded bool) {
				assert := assert.New(t)
				assert.False(loaded)
		...
		},
		{
			name: "host not found",
			mock: func(mock redismock.ClientMock, mockHostManager *MockHostManagerMockRecorder, mockTaskManager *MockTaskManagerMockRecorder) {
				mock.ExpectHGetAll(pkgredis.MakePersistentCachePeerKeyForPersistentCacheTaskInScheduler(42, mockPeer.ID)).SetVal(mockRawPeerFields(mockPeer.ID))
...
func TestPeerManager_LoadAll(t *testing.T) {
	prefix := fmt.Sprintf("%s:", pkgredis.MakePersistentCachePeersForPersistentCacheTaskInScheduler(42))
	tests := []struct {
		name   string
		mock   func(mock redismock.ClientMock, mockHostManager *MockHostManagerMockRecorder, mockTaskManager *MockTaskManagerMockRecorder)
...
func TestPeerManager_LoadAllByTaskID(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "redis error",
			mock: func(mock redismock.ClientMock, mockHostManager *MockHostManagerMockRecorder, mockTaskManager *MockTaskManagerMockRecorder) {
				mock.ExpectSMembers(pkgredis.MakePersistentCachePeersOfPersistentCacheTaskInScheduler(42, mockTask.ID)).SetErr(errors.New("redis error"))
			},
			expect: func(t *testing.T, peers []*Peer, err error) {
				assert := assert.New(t)
				assert.Error(err)
		...
		},
		{
			name: "peer that fails to load is skipped",
			mock: func(mock redismock.ClientMock, mockHostManager *MockHostManagerMockRecorder, mockTaskManager *MockTaskManagerMockRecorder) {
				mock.ExpectSMembers(pkgredis.MakePersistentCachePeersOfPersistentCacheTaskInScheduler(42, mockTask.ID)).SetVal([]string{"peer1"})
				mock.ExpectHGetAll(pkgredis.MakePersistentCachePeerKeyForPersistentCacheTaskInScheduler(42, "peer1")).SetErr(errors.New("redis hgetall error"))
			},
			expect: func(t *testing.T, peers []*Peer, err error) {
				assert := assert.New(t)
...
func TestPeerManager_LoadAllIDsByTaskID(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name: "successful load",
			mock: func(mock redismock.ClientMock) {
				mock.ExpectSMembers(pkgredis.MakePersistentCachePeersOfPersistentCacheTaskInScheduler(42, mockTask.ID)).SetVal([]string{"peer1", "peer2"})
			},
			expect: func(t *testing.T, peerIDs []string, err error) {
				assert := assert.New(t)
				assert.NoError(err)
...
func TestPeerManager_LoadAllByHostID(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "redis error",
			mock: func(mock redismock.ClientMock, mockHostManager *MockHostManagerMockRecorder, mockTaskManager *MockTaskManagerMockRecorder) {
				mock.ExpectSMembers(pkgredis.MakePersistentCachePeersOfPersistentCacheHostInScheduler(42, mockRawHost.ID)).SetErr(errors.New("redis error"))
			},
			expect: func(t *testing.T, peers []*Peer, err error) {
				assert := assert.New(t)
				assert.Error(err)
		...
		},
		{
			name: "peer that fails to load is skipped",
			mock: func(mock redismock.ClientMock, mockHostManager *MockHostManagerMockRecorder, mockTaskManager *MockTaskManagerMockRecorder) {
				mock.ExpectSMembers(pkgredis.MakePersistentCachePeersOfPersistentCacheHostInScheduler(42, mockRawHost.ID)).SetVal([]string{"peer1"})
				mock.ExpectHGetAll(pkgredis.MakePersistentCachePeerKeyForPersistentCacheTaskInScheduler(42, "peer1")).SetErr(errors.New("redis hgetall error"))
			},
			expect: func(t *testing.T, peers []*Peer, err error) {
				assert := assert.New(t)
...
func TestPeerManager_LoadAllIDsByHostID(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name: "successful load",
			mock: func(mock redismock.ClientMock) {
				mock.ExpectSMembers(pkgredis.MakePersistentCachePeersOfPersistentCacheHostInScheduler(42, mockRawHost.ID)).SetVal([]string{"peer1", "peer2"})
			},
			expect: func(t *testing.T, peerIDs []string, err error) {
				assert := assert.New(t)
				assert.NoError(err)
