						...
						CandidateParents: []*commonv2.Peer{
							{
								...
								Host: &commonv2.Host{
									...
									Network: &commonv2.Network{
										...
										RxBandwidth:              &candidateParents[0].Host.Network.DownloadRate,
										MaxRxBandwidth:           candidateParents[0].Host.Network.DownloadRateLimit,
										TxBandwidth:              &candidateParents[0].Host.Network.UploadRate,
										MaxTxBandwidth:           candidateParents[0].Host.Network.UploadRateLimit,
									},
									Disk: &commonv2.Disk{
